...
public class Tet5Script : MonoBehaviour {
	...
	void Start () {
		...
		GameObject newBlock3 = (Instantiate (blockPrefab, transform.position + new Vector3 (-1,-2), Quaternion.identity)) as GameObject;
		blocks.Add (newBlock3);
		GameObject newBlock4 = (Instantiate (blockPrefab, transform.position + new Vector3 (0,-2), Quaternion.identity)) as GameObject;
